"use strict";
// Shim: re-exports symbols the webex extension needs from individual plugin-sdk subpaths.
// This file is only needed when the published openclaw package does not ship
// dist/plugin-sdk/webex.js. Once a version includes the real barrel, the Dockerfile
// skips copying this shim (the exports-entry check gates it).

Object.defineProperty(exports, "__esModule", { value: true });

// --- re-exports from individual subpaths ---

const channelPairing = require("./channel-pairing.js");
exports.createChannelPairingController = channelPairing.createChannelPairingController;
exports.createPairingPrefixStripper = channelPairing.createPairingPrefixStripper;
exports.createTextPairingAdapter = channelPairing.createTextPairingAdapter;
exports.PAIRING_APPROVED_MESSAGE = channelPairing.PAIRING_APPROVED_MESSAGE;
...
const commandAuth = require("./command-auth.js");
exports.resolveDirectDmAuthorizationOutcome = commandAuth.resolveDirectDmAuthorizationOutcome;
exports.resolveSenderCommandAuthorizationWithRuntime = commandAuth.resolveSenderCommandAuthorizationWithRuntime;

const runtime = require("./runtime.js");
exports.waitForAbortSignal = runtime.waitForAbortSignal;

const accountHelpers = require("./account-helpers.js");
exports.createAccountListHelpers = accountHelpers.createAccountListHelpers;
exports.resolveMergedAccountConfig = accountHelpers.resolveMergedAccountConfig;
exports.describeAccountSnapshot = accountHelpers.describeAccountSnapshot;

const accountId = require("./account-id.js");
exports.DEFAULT_ACCOUNT_ID = accountId.DEFAULT_ACCOUNT_ID;
exports.normalizeAccountId = accountId.normalizeAccountId;

const channelConfigSchema = require("./channel-config-schema.js");
exports.buildChannelConfigSchema = channelConfigSchema.buildChannelConfigSchema;

const secretInput = require("./secret-input.js");
exports.buildSecretInputSchema = secretInput.buildSecretInputSchema;
exports.normalizeSecretInputString = secretInput.normalizeSecretInputString;

const paramReaders = require("./param-readers.js");
exports.readStringParam = paramReaders.readStringParam;

const agentRuntime = require("./agent-runtime.js");
exports.jsonResult = agentRuntime.jsonResult;
